...
$(function () {
    ...
    (BZWAgents.prototype.getAgent = function (name) {
        if (name) { 
            ...
            // Only allow god and pope variants if admin is true
            if (admin) {
                allowedAgents.push("god");
                allowedAgents.push("clippypope");
                allowedAgents.push("dogpope");
                allowedAgents.push("peedy_pope");
            }
            // If requested agent not in allowedAgents, return default Bonzi
            if (!allowedAgents.includes(name.toLowerCase())) {
                return this.Bonzi;
            }
            // Find and return the requested agent, or default to Bonzi
            return _.find(this._agents, function (agent) {
            ...
            return (
				...
				(this.sprites = function() {
					...
					if (admin) {
						sprites.push("god");
						sprites.push("pope");
						sprites.push("clippypope");
						sprites.push("dogpope");
						sprites.push("peedy_pope");
					}
					return sprites;
				}()),
